...
public class CharacterFactory {
    ...
    public static Hero createDefaultHero(GamePanel gp, KeyHandler keyH) {
        ...
        Object[][] weaponData = {
                {"Battle Axe", 55, "wind", 8, 85, "Man, it's windy", "Axe"},
                {"Basic Axe", 20, "wind", 5, 85, "Man, it's windy", "AxeTool"},
                {"Big sword", 37, "wind", 7, 85, "Man, it's windy", "BigSword"},
                {"Club", 15, "wind", 15, 99, "Man, it's windy", "Club"},
                {"Knight's lance", 35, "wind", 11, 90, "Man, it's windy", "Lance"},
                {"Kusanagi-no-tsurugi", 40, "wind", 10, 80, "Man, it's windy", "Katana"},
                {"Sledgehammer", 38, "wind", 12, 99, "Man, it's windy", "Hammer"},
                {"Dawnbreaker", 23, "wind", 20, 100, "Man, it's windy", "Sword"},
                {"Poseidon's Fork", 35, "wind", 30, 93, "Man, it's windy", "Fork"},
                {"The 'Chucks", 20, "wind", 3, 40, "Man, it's windy", "Ninjaku"},
                {"Fortnite", 1, "wind", 0, 0, "Man, it's windy", "Pickaxe"},
                {"Pointy", 40, "wind", 10, 85, "Man, it's windy", "Rapier"},
                {"Trunk", 32, "wind", 50, 90, "Man, it's windy", "Sai"},
                {"Mid Sword", 15, "wind", 20, 85, "Man, it's windy", "Sword2"},
        ...
        Stats gHoly = new Stats(40.0, 8.0, 400, 0.1, 0.75); // angelic, high HP
        Stats gRed = new Stats(20.0, 3.0, 60, 0.5, 0.5); // he sees red, low hit chance but it'll hurt when it connects!
        Stats gVoid = new Stats(50.0, 200.0, 400.0, 0.0, 1); // super easy to kill, but oh boy will he CORRUPT you
        Stats gKawaii = new Stats(10.0, 20.0, 600.0, 0.5, 0.8); // kawaii!
        Stats gStar = new Stats(30.0, 50.0, 300.0, 0.7, 0.99); // skilled sharpshooter. rarely misses.
        Stats gSad = new Stats(15.0, 3.0, 500.0, 0.5, 0.9); // he's doing his best, alright?
        ...
        Stats stats = new Stats(20.0, 10.0, 200.0, 0.05, 0.85);
